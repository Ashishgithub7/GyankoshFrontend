...
import com.example.practice.Notes.TopicExpandableListAdapter;
...
public class PhysicsVideoFragment extends Fragment {
    private ExpandableListView expandableListView;
    private List<NoteTopic> topics;

    public PhysicsVideoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_physics_video, container, false);
    ...
    private void prepareData() {
        ...
        topics.add(new NoteTopic("Mechanics", Arrays.asList("Arjun Sir","Pranish Sir","Temperature")));
