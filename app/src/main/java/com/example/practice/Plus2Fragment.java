...
public class Plus2Fragment extends Fragment {

    private LinearLayout mcq,note;
    public Plus2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_plus2, container, false);
        ...
        mcq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("COURSE_NAME", "+2 LEVEL");
